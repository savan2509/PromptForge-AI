  ...
  return (
    <div className="md:hidden">
      <button
        ...
        aria-expanded={open}
        className="flex h-11 w-11 items-center justify-center rounded-md border border-black/10 dark:border-white/20"
      >
          ...
          {isSignedIn ? (
            <>
              ...
              <button
                ...
                className="rounded-md px-3 py-2 text-left text-neutral-500 hover:bg-black/5 dark:text-neutral-400 dark:hover:bg-white/10"
              >
                Sign out
              </button>
            </>
